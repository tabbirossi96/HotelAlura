...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/imagenes/aH-40px.png")));// Adiciona
																													// el
																													// ícono
																													// a
																													// nuestro
	...
	private void guardarReserva() {
		...
		JOptionPane.showMessageDialog(null, "Registro Guardado con éxito " + nuevaReserva.getId()); //en lugar de null dice contentPane 
